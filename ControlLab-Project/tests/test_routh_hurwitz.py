...
class TestRouthHurwitzBasic(unittest.TestCase):
    ...
    def test_stable_system(self):
        ...
        self.assertEqual(result.unstable_poles_count, 0)
    ...
    def test_unstable_system(self):
        ...
        self.assertGreater(result.unstable_poles_count, 0)
...
class TestRouthHurwitzParametric(unittest.TestCase):
    ...
    def test_parametric_stability(self):
        ...
        self.assertIsNotNone(result.stable_range)
...
class TestRouthHurwitzPedagogical(unittest.TestCase):
    ...
    def test_step_by_step_analysis(self):
        ...
        # Deve ter explicações
        report = result.history.get_formatted_report()
        self.assertIn("ANÁLISE DE ROUTH-HURWITZ", report)
        self.assertIn("PASSOS DA CONSTRUÇÃO", report)
    ...
    def test_standalone_functions(self):
        ...
        self.assertIsNotNone(result)
        self.assertTrue(hasattr(result, 'is_stable'))
